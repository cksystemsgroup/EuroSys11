							...
							<td width = "80%" valign ="top">
								<div id="id3" class="style_SkipStroke_1 shape-with-text">
					            	<div class="text-content style_External_700_447" style="padding: 0px; ">
										<div class="style">
											<p class="paragraph_style_2">Eurosys2011 Registration</p>
											<p class="paragraph_style_3"> The payment and registration to Eurosys 2011 was successful. If you have any questions please contact the <a href="oc.php">registration chair</a>.
											</p>
